...
const router = createBrowserRouter(
    createRoutesFromElements(
        <Route path='/business_frames' element={<RootLayout />}>
            ...
            <Route path='/business_frames/branches' element={<BranchesWrapperComponent />}>
            ...
            <Route path='/business_frames/members' element={<MembersWrapperComponent />}>
            ...
            <Route path='/business_frames/service-providers' element={<ServiceProvidersWrapperComponent />}>
